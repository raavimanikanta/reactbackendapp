...
const Tollywood = () => {
  ...
  return (
    <div className="category-cont">
     ...
     <div><h2>Tollywood</h2></div>
     <div className='toppost-border'></div>
     </div>
          {
              Details.filter((result=>result.id>5&&result.id<11)).map((technologies,index)=>
              <div className='design'>
                  <div>
              <Link to={`/Tollywood/${technologies.id}`}><img className="images" src={technologies.image} alt="" /></Link>
                  </div>
  ...
  <div className='main-cont1'>
    ...
    Details.filter((result=>result.id>23&&result.id<28)).map((technologies,index)=>
        <div className='design1'>
          <div >
          <Link to={`/Tollywood/${technologies.id}`}><img className="images1" src={technologies.image} alt="" /></Link>
          </div>
          <div className='content-data'>
        <div >
